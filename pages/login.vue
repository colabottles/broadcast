    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div class="oauth-buttons">
          ...
          <button
            @click="handleOAuthLogin('azure')"
            class="btn btn-outline oauth-btn"
            :disabled="loading"
          >
            <svg width="18" height="18" viewBox="0 0 21 21" fill="currentColor" aria-hidden="true">
        ...
        <p class="auth-terms">
          ...
          <a href="/pages/terms" class="auth-link">Terms of Service</a>
          and
          <a href="/pages/privacy" class="auth-link">Privacy Policy</a>
        </p>
...
// Handle OAuth login
const handleOAuthLogin = async (provider: 'google' | 'github' | 'azure' | 'discord' | 'linkedin_oidc') => {
  loading.value = true
  errorMessage.value = ''
